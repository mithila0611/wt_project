...
$query = "SELECT score, attempts FROM quiz_resultshigh WHERE student_name = ?";
...
if ($result->num_rows > 0) {
    ...
    $update_query = "UPDATE quiz_resultshigh SET score = ?, time_taken = ?, attempts = ?, attempt_date = NOW() WHERE student_name = ?";
    ...
    $attempts = 1;
    $insert_query = "INSERT INTO quiz_resultshigh (student_name, attempts, score, time_taken, attempt_date) VALUES (?, ?, ?, ?, NOW())";
